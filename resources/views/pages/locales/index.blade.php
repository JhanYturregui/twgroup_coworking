    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-header border-0">
          <div class="row">
            <h3 class="mb-0 col-8">{{ __('Mantenimiento de Locales') }}</h3>
            <div class="col-4 text-right">
              <a href="{{ route('locales_crear') }}" class="btn btn-primary botones-expand">
          ...
          <table id="tablaPrincipal" class="table align-items-center table-flush">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="sort" data-sort="name">{{ __('Dirección') }}</th>
