...
class LocalController extends Controller
{
  ...
  */
  public function obtenerDatos() {
    ...
    return datatables()
      ->queryBuilder($query)
      ->addColumn('col-estado', 'pages.locales.columnas.estado')
      ->addColumn('col-acciones', 'pages.locales.columnas.acciones')
  ...
  public function validarDatos($datos, $id) {
    ...
    $mensajes = [
      ...
      'nombre.unique'    => 'El MODELO ya está registrado.',
      'nombre.max'       => 'El campo MODELO puede tener máximo 100 caracteres.',
    ];
  ...
  public function create() {
    $codigosUbigeo = $this->ubigeo->obtenerCodigosUbigeo(null, null);
    
    $dptos = $codigosUbigeo['departamentos'];

    return view('pages.locales.crear', compact('dptos'));
  }
